        ...
        var strTableFiles = new LABKEY.ext.Store({
            listeners: {
                load: function(){
                    ...
                    var tempXMLSampleGroup = cbXML.getValue() + cbSampleGroup.getValue();
...
//                    },
        ...
        var cbXML = new Ext.ux.form.ExtendedComboBox({
...
//                        manageWorkspace();
        ...
        var cbSampleGroup = new Ext.ux.form.ExtendedComboBox({
            disabled: true,
